...
//        add(midpan);
    ...
    public void mouseEntered(MouseEvent e) {
        if (e.getSource() == attendance) {
            attendance.setBackground(new Color(40, 108, 40)); // Restore original background color on exit
    ...
    public void mouseExited(MouseEvent e) {
        if (e.getSource() == attendance) {
            attendance.setBackground(new Color(29, 75, 100)); // Restore original background color on exit
            attendance.setForeground(new Color(255, 255, 255));
        }
    }
}
