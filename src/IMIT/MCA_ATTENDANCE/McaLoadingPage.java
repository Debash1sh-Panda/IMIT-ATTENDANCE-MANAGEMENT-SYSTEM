...
public class McaLoadingPage extends JFrame implements Runnable{
    ...
    McaLoadingPage( String staffname,String Designation,String department,String email_id, String image ){
        ...
        JLabel titletext = new JLabel ("IMIT MCA ATTENDANCE APPLICATION");
        titletext.setBounds(40, 20, 600, 40);
